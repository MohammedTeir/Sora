    ...
    override fun Content() {
        ...
        Scaffold(
            ...
            BrowseSourceContent(
                ...
                onSetMirrorUrlClick = if (screenModel.source is HttpSource) {
                    { screenModel.setDialog(BrowseSourceScreenModel.Dialog.SetMirrorUrl) }
                } else {
                    null
                },
        ...
        when (val dialog = state.dialog) {
            ...
            is BrowseSourceScreenModel.Dialog.SetMirrorUrl -> {
                MirrorUrlDialog(
                    currentUrl = screenModel.getCustomUrl(),
                    defaultUrl = screenModel.getSourceBaseUrl(),
                    onDismiss = onDismissRequest,
                    onSave = { url -> screenModel.saveCustomUrl(url) },
                )
            }
            else -> {}
        }
...
private fun MirrorUrlDialog(
    ...
    var inputUrl by rememberSaveable { mutableStateOf(currentUrl) }
    ...
    AlertDialog(
        ...
        confirmButton = {
            TextButton(onClick = { onSave(inputUrl) }) {
