...
class LibraryScreenModel(
    ...
    init {
        ...
        screenModelScope.launchIO {
            ...
            ) { (data, isSearchBlank, hasActiveFilters), showHiddenCategories ->
                data.favorites
                    .applyGrouping(
                        data.categories,
                        data.showSystemCategory,
                        showHiddenCategories || !isSearchBlank || hasActiveFilters,
                    )
    ...
    private fun List<LibraryItem>.applyGrouping(
        ...
        return categories.filter { (showSystemCategory || !it.isSystemCategory) && (showHiddenCategories || !it.hidden) }
